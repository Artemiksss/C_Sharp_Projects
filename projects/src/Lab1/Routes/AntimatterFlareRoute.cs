...
public class AntimatterFlareRoute
{
    private readonly ICollection<IObstacle> _obstacles;
    public AntimatterFlareRoute(int length, ICollection<IObstacle> obstacles)
    {
        LenRoute = length;
    ...
    public bool StartAntimatterFlare(Spaceship? spaceship)
    {
