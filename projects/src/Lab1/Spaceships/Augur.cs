...
{
    private const double SpaceFuelTankCapacity = 14000;
        ...
        : base()
    {
        ...
        CaseStrength = new StrengthOfClassThird();
    ...
    public override void Damage(IObstacle? obstacle)
    {
        ...
        {
            if (obstacle != null && HitPoints != null)
            {
                HitPoints.ChangeHitPointsDeflector(obstacle.ObstacleDamage);
            }
        }
