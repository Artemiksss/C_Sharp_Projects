...
public class TestWithInsufficientHeatDissipationPower
{
    [Theory]
    [MemberData(nameof(DataForTestWithInsufficientPowerDissipation.TestData), MemberType = typeof(DataForTestWithInsufficientPowerDissipation))]
