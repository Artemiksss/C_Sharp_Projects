...
public static class DataForTestWithInsufficientPowerDissipation
{
    public static IEnumerable<object[]> TestData()
    {
        return new List<object[]>
        {
            new object[]
            {
                ...
                new GraphicsAdapter(11, 25, 6, 3, 1550, 340),
                new Hdd(5, 5, 6),
                new PowerUnit(450),
                new ProcessorCoolingSystem(12, 12, "LGA 2011", 90),
                new Ram(16, 400, "XMP", "DIMM", "DDR4", 2),
                new Ssd("PCI", 1024, 550, 4),
                new SystemBlock(53, 30, "EATX",  70, 50),
                new Bios("Award Phoenix", "3.XX", "intel i5, intel i7"),
